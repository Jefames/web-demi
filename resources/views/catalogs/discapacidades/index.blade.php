...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><b>Discapacidades</b></h1>
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h2 class="card-title">
                        ...
                        <b>Listado de Discapacidades</b>
                    </h2>
                </div>
                <div class="card-header">
                    <a href="{{ route('discapacidades.create') }}" class="btn btn-primary btn-flat btn-sm">
                ...
                <div class="card-body">
                    {{--                    <div class="container">--}}
                    <br>
                    <table class="table table-bordered" id="discapacidades">
                        <thead>
                        <tr>
                            <th>ID</th>
                            <th>Discapacidad</th>
...
{{--                                    <a href="#" class="btn btn-info btn-flat btn-sm"><i class="fas fa-eye"></i></a>--}}
                                    <a href="{{ route('discapacidades.edit',$discapacidad->id ) }}" class="btn btn-sm btn-warning btn-flat "><i class="fas fa-edit"></i></a>
                                    <form action="{{ route('users.inactivar', $discapacidad->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('PATCH')
