            ...
            <div class="card card-default">
                <div class="card-header">
                    <h2 class="card-title">
                        ...
                        <b>Expedientes - Coordinación Interinstitucional</b>
                    </h2>
                </div>
                <div class="card-header">
                    <a href="{{ route('cord_interinstitucional.create') }}" class="btn btn-primary btn-flat btn-sm">
                        <i class="fas fa-file-medical"></i> Nuevo Expediente CI
                    </a>
                </div>
                <div class="card-body">
{{--                    <div class="container">--}}
                        ...
                        <table class="table table-bordered" id="expedientes">
                            ...
                            @foreach($expedientes as $expediente)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('cord_interinstitucional.show', $expediente->id) }}" class="btn btn-success btn-flat btn-sm"><i class="fas fa-eye"></i></a>
                                        <a href="{{ route('cord_interinstitucional.edit', $expediente->id) }}" class="btn btn-sm btn-warning btn-flat "><i class="fas fa-edit"></i></a>
