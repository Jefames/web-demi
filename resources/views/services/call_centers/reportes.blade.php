...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><b>Reporte de Expedientes</b></h1>
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h2 class="card-title">
                        ...
                        <b>Expedientes - Generación de Reportes</b>
                    </h2>
                </div>

                <div class="card-body">
                    <form action="{{ route('call_centers.reporte.export') }}" method="POST" target="_blank">
                        @csrf
                        <div class="row">
                            <div class="col-md-3">
